...
> **v2.1.0** · 30 агентов · 22 архетипа · 24 правила безопасности · 9 хуков · ~$34/мес на проект · PoC за 47 минут · MIT
...
|---|---|---|---|---|
| Multi-agent SDLC pipeline | ✓ 30 специалистов | ✕ | ✕ | ✕ |
| Авто-детект архетипа | ✓ 22 типа | ✕ | ✕ | ✕ |
