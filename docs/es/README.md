...
Cada hook respeta variables de entorno `GREAT_CTO_DISABLE_<NAME>=1` (ej. `GREAT_CTO_DISABLE_SECRET_SCAN=1`). Opt-out por archivo vía `// great_cto:allow-secrets` para el hook secret-scan.
