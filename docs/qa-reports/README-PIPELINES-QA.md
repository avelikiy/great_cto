...
This directory contains the complete QA analysis of `/Users/avelikiy/development/great_cto/skills/great_cto/PIPELINES.md` (version 1.2), a critical reference file mapping 55 project types to QA strategies, deploy methods, thresholds, and security gates.
...
**Files analyzed:**
- `/Users/avelikiy/development/great_cto/skills/great_cto/PIPELINES.md` (version 1.2)

---

## Related Documents

- **PIPELINES.md:** `/Users/avelikiy/development/great_cto/skills/great_cto/PIPELINES.md`
- **PROJECT.md:** `/Users/avelikiy/development/great_cto/.great_cto/PROJECT.md` (type definitions)
