...
npx --yes great-cto@3.32.0 codex-host start --dir /path/to/project --allow src,docs --prompt 'Implement the specified feature'
npx --yes great-cto@3.32.0 codex-host status <run-uuid>
npx --yes great-cto@3.32.0 codex-host approve <run-uuid> --token <pending-token>
npx --yes great-cto@3.32.0 codex-host resume <run-uuid>
npx --yes great-cto@3.32.0 codex-host recover <run-uuid>
npx --yes great-cto@3.32.0 codex-host cancel <run-uuid>
npx --yes great-cto@3.32.0 codex-host list --dir /path/to/project
```
