...
npx --yes great-cto@3.36.1 codex-host start --dir /path/to/project --allow src,docs --prompt 'Implement the specified feature'
npx --yes great-cto@3.36.1 codex-host status <run-uuid>
npx --yes great-cto@3.36.1 codex-host approve <run-uuid> --token <pending-token>
npx --yes great-cto@3.36.1 codex-host resume <run-uuid>
npx --yes great-cto@3.36.1 codex-host recover <run-uuid>
npx --yes great-cto@3.36.1 codex-host cancel <run-uuid>
npx --yes great-cto@3.36.1 codex-host list --dir /path/to/project
```
