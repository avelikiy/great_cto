...
flowchart TD
  ...
  libs["Libraries<br/><small>136 files</small>"]
  board["Board<br/><small>80 files</small>"]
...
| `libs` | 136 | the logic hooks and commands share |
| `board` | 80 | the admin view, zero runtime dependencies |
