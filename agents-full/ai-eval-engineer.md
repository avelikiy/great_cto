...
description: "Builds and maintains the eval pipeline for ai-system / agent-product archetypes."
model: haiku
authority: proposes
...
<<< END agents/_shared/skill-catalog-browse.md >>> with `<agent-name> = ai-eval-engineer`.
