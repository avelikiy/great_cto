...
// TEMPORARY export: data-readers.mjs needs this until getTasks moves to
// lib/beads.mjs (extraction step 8); the export keyword is removed then.
export function getTasks(cwd = process.cwd()) {
