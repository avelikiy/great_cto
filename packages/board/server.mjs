...
// TEMPORARY export: data-readers.mjs needs this until readVerdicts moves to
// lib/verdicts.mjs (extraction step 10); the export keyword is removed then.
export function readVerdicts(cwd = null) {
...
// TEMPORARY export: metrics.mjs needs this until readPlanCosts moves to
// lib/verdicts.mjs (extraction step 10); the export keyword is removed then.
export function readPlanCosts(cwd = process.cwd(), sinceMsAgo = null) {
...
// TEMPORARY export: metrics.mjs needs this until readQAStats moves to
// lib/verdicts.mjs (extraction step 10); the export keyword is removed then.
export function readQAStats(cwd = process.cwd()) {
...
// TEMPORARY export: data-readers.mjs needs this until readSecStats moves to
// lib/verdicts.mjs (extraction step 10); the export keyword is removed then.
export function readSecStats(cwd = process.cwd()) {
