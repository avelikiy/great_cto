...
import { readAlertsFired, writeAlertsFired, fireEmailAlert, firePushAlert, startAlertCron } from './lib/alerts.mjs';
...
// TEMPORARY export: alerts.mjs needs this until getShareState moves to
// lib/share.mjs (extraction step 13); the export keyword is removed then.
export function getShareState(cwd = process.cwd()) {
...
// TEMPORARY export: alerts.mjs needs this until toggleShare moves to
// lib/share.mjs (extraction step 13); the export keyword is removed then.
export async function toggleShare(enable, cwd = process.cwd(), force = false) {
