...
cp "$(ls ~/.claude/plugins/cache/*/great_cto/*/skills/great_cto/memory-index.md 2>/dev/null | awk -F'/plugins/cache/' '{split($NF,p,"/"); print p[3], $0}' | sort -V | tail -1 | cut -d' ' -f2-)" .great_cto/memory/MEMORY.md
