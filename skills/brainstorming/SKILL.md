...
|---|---|---|---|
| **Visionary** | the strongest case FOR — the 10x outcome if it works | `claude-opus-5` | `Task`, `model: opus` |
| **Skeptic** | the strongest case AGAINST — why it fails / who tried & died | `claude-sonnet-5` | `Task`, `model: sonnet` |
