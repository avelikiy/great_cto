...
npx --yes great-cto@3.37.0 codex-host list --dir /absolute/project
```
...
```sh
npx --yes great-cto@3.37.0 codex-host start \
...
```sh
npx --yes great-cto@3.37.0 codex-host approve RUN_UUID --token GATE_TOKEN
npx --yes great-cto@3.37.0 codex-host approve-release RUN_UUID --token RELEASE_TOKEN
npx --yes great-cto@3.37.0 codex-host resume RUN_UUID
```
