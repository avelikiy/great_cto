...
[![Version](https://img.shields.io/badge/version-1.0.103-blue)]()
...
v1.0.103 — actively maintained. MIT license, no telemetry, no SaaS lock-in. File-based configs in `.great_cto/` — inspect and edit anything.
