...
# derived term from a nested bin/ directory blocked a push over
# GREAT_CTO_CODEX_BIN (2026-09-06). Newlines become spaces before any compare.
_STOPWORDS=$(printf '%s' "$_STOPWORDS" | tr '\n' ' ')
